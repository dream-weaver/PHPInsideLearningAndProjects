<?php 
	...
	if( mysqli_num_rows($result) > 0 ) {
		...
		$alertMessage = "<div class = 'alert alert-success'>Nothing to see here. <a href='client.php'>Head back</a>.</div>";
	}
	//check to see if update button was submitted
	...
	//if the delete button was submitted
...
<form action = "<?php echo htmlspecialchars($_SERVER["PHP_SELF"]) ?>?id=<?php echo $clientID; ?>" method="post" class="row">
	...
	<div class="form-group col-sm-6">
		...
		<textarea type="text" class="form-control input-lg" id="client-notes" name="clientNotes" value="<?php echo $clientNotes; ?>"><?php echo $clientNotes; ?></textarea> 
	</div> 
	<div class="col-sm-12">
		<hr>
